...
/**
 * Sorts the array using insertion sort. Uses time proportional to
 * <code>&theta;(n<sup>2</sup>)</code> and no additional space, where <code>n</code> is
 * the number of elements to sort. The sort is stable.
 *
 * @author Aniket Kumar
 */
